...
name varchar(20) primary key,quantity int
);
create table undelivered(orderID int primary key,flour_qty int, cheese_qty int);
...
insert into inventory values ('flour',150);
insert into inventory values ('cheese',150);